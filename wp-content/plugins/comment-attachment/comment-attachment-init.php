...
//                '<label  class="comments-form__file-label">' . ATT_TITLE . $required.
//                '<input id="attachment" name="attachment" type="file" /></label>';
            echo '<label class="comments-form__file-label" for="attachment">' . ATT_TITLE . $required . '</label><input class="comments-form__file" type="file" name="attachment" id="attachment">';
        }
