        ...
        <a class="link link__control news__link i-bem" data-bem='{"link":{}}' role="link" tabindex="0" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
            <div class="news news_type_list">
                <div class="news__image">
                    ...
                    ?>
                        <img class="image" src="<?php the_post_thumbnail_url(); ?>" title="<?php the_title(); ?>">
                    <?php endif; ?>
                </div>
                <div class="news-description news__description">
                    <h4 class="news-description__title"><?php the_title(); ?></h4>
                    <p class="news-description__info"><span class="news-description__date"><?php echo date('Y.m.d', strtotime($post->post_date)); ?></span><span class="news-description__comments fa fa_icon_comments-o"><?php echo $post->comment_count; ?></span>
                    </p>
